...
import com.sg.pages.AddPatientPage;
...
public class PatientStepDefinition {
	...
	public void i_handle_alert() {
		actualAlertValue = AddPatientPage.handleAlertAndGetAlertText();
	...
	@Then("I validate the added patient details {string}")
	public void i_validate_the_added_patient_details(String expectedValue) {
			WebDriverWrapper.driver.switchTo().frame("pat");
